...
- 如果你在看 Harness Engineering，优先按：`MCP 与 CLI 模式 -> Computer Use Runtime and Safety -> App Server 与 Rich Agent Protocols -> Harness Engineering -> 技能、插件、应用与自动化：Harness 的扩展面 -> Harness 工作流与自动化模式图` 这条图线读
