...
2. 如果你想快速浏览结构关系，打开 [[AI 五大专题导航.canvas|AI 五大专题导航（Canvas）]]
3. 如果你想像数据库一样筛选总览、索引、地图和状态页，打开 [[AI 五大专题导航.base|AI 五大专题导航（Base）]]
4. 如果你在研究具体开源项目，先跳去 `AI-Open-Source`
5. 如果你已经明确自己要学哪条线，再回到对应 area 的 `专题总览` 继续深入
